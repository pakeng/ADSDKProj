...
public class APPUtil {
    ...
    private static final String SHARE_APP_TAG = "ddx";
    ...
    public static boolean isFirstStart(Context ctx){
        SharedPreferences setting = ctx.getSharedPreferences(SHARE_APP_TAG, 0);
    ...
    public static void setFirstStartFlag(Context ctx){
        SharedPreferences setting = ctx.getSharedPreferences(SHARE_APP_TAG, 0);
