...
public class StringUtil {
    ...
    public static String formatNumber(int number){
        ...
        /*取整*/
        int roundNumber = number / 10000;
        /*取*/
        int remainder = number % 10000;
        /*余数取整*/
        int roundNumber2 = remainder / 100;
        if(number >= 10000){
            if(roundNumber2 == 0){
                numberStr =  roundNumber + unit;
            }else{
                int remainder2 = roundNumber2 % 10;
                if(remainder2 == 0){
                    roundNumber2 = roundNumber2 / 10;
                }
                numberStr =  roundNumber + "." + roundNumber2 + unit;
            }
        }
        return numberStr;
    }
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("1000=" + StringUtil.formatNumber(1000));
        System.out.println("10000=" + StringUtil.formatNumber(10000));
        System.out.println("10001=" + StringUtil.formatNumber(10001));
        System.out.println("12010=" + StringUtil.formatNumber(1209000));
        System.out.println("120010=" + StringUtil.formatNumber(120010));
        System.out.println("100010=" + StringUtil.formatNumber(1000018810));

        System.out.println("22=" + "application/json".contains("application/json"));
        System.out.println("22=" + "application/json;".contains("application/json"));
        System.out.println("22=" + "application/json;utf-8".contains("application/json"));
        System.out.println("22=" + "application/json;utf-8".contains("application/json;utf-8"));
        System.out.println("22=" + "application/json;".contains("application/json;utf-8"));
